...
Then it loads the best model, predicts future water depth for train and test data and saves predictions to CSV files. It also plots water depth from seq2seq LSTM and ground-truth TUFLOW for 6 streets.
